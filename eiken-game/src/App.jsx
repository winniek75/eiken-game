...
const getDailyChallenge = (saved) => {
  ...
  let pool;
  if (level >= 10) pool = [5, 4, 3];
  else if (level >= 5) pool = [5, 4];
  else pool = [5];
  // 既に今日のチャレンジがあっても、級がプレイヤーに合わなければ再生成
  if (saved.dailyChallenge.date === today && pool.includes(saved.dailyChallenge.grade)) {
    return saved.dailyChallenge;
  }
...
const grade5Questions = [
  ...
  { type: 'grammar', question: 'I ___ a student.', options: ['is', 'am', 'are', 'be'], answer: 1, hint: '「私は〜です」', translation: '私は学生です。' },
  { type: 'grammar', question: 'She ___ happy.', options: ['am', 'are', 'is', 'be'], answer: 2, hint: '「彼女は〜です」', translation: '彼女は幸せです。' },
  { type: 'grammar', question: 'They ___ my friends.', options: ['is', 'am', 'are', 'was'], answer: 2, hint: '「彼らは〜です」', translation: '彼らは私の友達です。' },
  { type: 'grammar', question: '___ you like music?', options: ['Are', 'Is', 'Do', 'Does'], answer: 2, hint: '「あなたは〜が好きですか？」', translation: 'あなたは音楽が好きですか？' },
  { type: 'grammar', question: 'I have ___ apple.', options: ['a', 'an', 'the', '-'], answer: 1, hint: '母音の前は...', translation: '私はりんごを1つ持っています。' },
  { type: 'grammar', question: 'This is ___ pen.', options: ['a', 'an', 'the', '-'], answer: 0, hint: '子音の前は...', translation: 'これはペンです。' },
  { type: 'grammar', question: 'He ___ tennis every day.', options: ['play', 'plays', 'playing', 'played'], answer: 1, hint: '三人称単数は...', translation: '彼は毎日テニスをします。' },
  { type: 'grammar', question: 'I can ___ English.', options: ['speak', 'speaks', 'speaking', 'spoke'], answer: 0, hint: 'canの後は原形', translation: '私は英語を話せます。' },
  { type: 'grammar', question: '___ is your name?', options: ['Who', 'What', 'Where', 'When'], answer: 1, hint: '「何」を聞いている', translation: 'あなたの名前は何ですか？' },
  { type: 'grammar', question: '___ do you live?', options: ['Who', 'What', 'Where', 'When'], answer: 2, hint: '「どこ」を聞いている', translation: 'あなたはどこに住んでいますか？' },
];
...
const grade4Questions = [
  ...
  { type: 'grammar', question: 'I have ___ to Kyoto twice.', options: ['go', 'went', 'been', 'going'], answer: 2, hint: '経験を表す現在完了', translation: '私は京都に2回行ったことがあります。' },
  { type: 'grammar', question: 'I have ___ my homework yet.', options: ['finish', 'finished', 'finishing', 'not finished'], answer: 3, hint: 'まだ〜していない', translation: '私はまだ宿題を終えていません。' },
  { type: 'grammar', question: 'She has ___ here for five years.', options: ['live', 'lived', 'living', 'lives'], answer: 1, hint: '継続を表す現在完了', translation: '彼女はここに5年間住んでいます。' },
  { type: 'grammar', question: 'Have you ever ___ sushi?', options: ['eat', 'ate', 'eaten', 'eating'], answer: 2, hint: '経験を尋ねる', translation: 'あなたは寿司を食べたことがありますか？' },
  { type: 'grammar', question: 'I have just ___ lunch.', options: ['have', 'had', 'having', 'has'], answer: 1, hint: '完了を表す', translation: '私はちょうど昼食を食べたところです。' },
  { type: 'grammar', question: 'He has ___ to America three times.', options: ['go', 'went', 'been', 'gone'], answer: 2, hint: '行ったことがある', translation: '彼はアメリカに3回行ったことがあります。' },
  { type: 'grammar', question: 'How long have you ___ English?', options: ['study', 'studied', 'studying', 'studies'], answer: 1, hint: 'どのくらい〜していますか', translation: 'あなたはどのくらい英語を勉強していますか？' },
  { type: 'grammar', question: 'I have never ___ such a beautiful place.', options: ['see', 'saw', 'seen', 'seeing'], answer: 2, hint: '一度も〜ない', translation: '私はこんなに美しい場所を見たことがありません。' },
  { type: 'grammar', question: 'This book is ___ than that one.', options: ['interesting', 'more interesting', 'most interesting', 'interestingly'], answer: 1, hint: '比較級', translation: 'この本はあの本よりおもしろいです。' },
  { type: 'grammar', question: 'He is the ___ student in our class.', options: ['tall', 'taller', 'tallest', 'more tall'], answer: 2, hint: '最上級', translation: '彼は私たちのクラスで一番背が高い生徒です。' },
  { type: 'grammar', question: 'She runs ___ than her brother.', options: ['fast', 'faster', 'fastest', 'more fast'], answer: 1, hint: '比較級', translation: '彼女はお兄さんより速く走ります。' },
  { type: 'grammar', question: 'This is the ___ movie I have ever seen.', options: ['good', 'better', 'best', 'most good'], answer: 2, hint: '最上級', translation: 'これは私が今まで見た中で一番いい映画です。' },
  { type: 'grammar', question: 'Tom is as ___ as his father.', options: ['tall', 'taller', 'tallest', 'more tall'], answer: 0, hint: '同等比較 as...as', translation: 'トムはお父さんと同じくらい背が高いです。' },
  { type: 'grammar', question: 'Which is ___, dogs or cats?', options: ['popular', 'more popular', 'most popular', 'popularer'], answer: 1, hint: '2つの比較', translation: '犬と猫ではどちらが人気がありますか？' },
  { type: 'grammar', question: 'The movie ___ by many people.', options: ['watch', 'watches', 'watched', 'was watched'], answer: 3, hint: '受動態', translation: 'その映画は多くの人に見られました。' },
  { type: 'grammar', question: 'I want ___ a doctor.', options: ['be', 'being', 'to be', 'been'], answer: 2, hint: 'want to ~', translation: '私は医者になりたいです。' },
  { type: 'grammar', question: 'He enjoys ___ tennis.', options: ['play', 'plays', 'playing', 'to play'], answer: 2, hint: 'enjoy ~ing', translation: '彼はテニスをすることを楽しみます。' },
  { type: 'grammar', question: 'This letter was ___ by my mother.', options: ['write', 'wrote', 'written', 'writing'], answer: 2, hint: '受動態の過去分詞', translation: 'この手紙は母によって書かれました。' },
  { type: 'grammar', question: 'She asked me ___ her.', options: ['help', 'helped', 'helping', 'to help'], answer: 3, hint: 'ask 人 to ~', translation: '彼女は私に手伝ってくれるよう頼みました。' },
  { type: 'grammar', question: 'I finished ___ my homework.', options: ['do', 'did', 'doing', 'to do'], answer: 2, hint: 'finish ~ing', translation: '私は宿題をやり終えました。' },
  { type: 'grammar', question: 'If it ___ tomorrow, I will stay home.', options: ['rain', 'rains', 'rained', 'raining'], answer: 1, hint: '条件節は現在形', translation: 'もし明日雨が降ったら、私は家にいます。' },
  { type: 'grammar', question: 'She ___ cooking when I arrived.', options: ['is', 'was', 'were', 'been'], answer: 1, hint: '過去進行形', translation: '私が着いたとき、彼女は料理をしていました。' },
  { type: 'grammar', question: '___ it was raining, we went out.', options: ['Because', 'Although', 'If', 'When'], answer: 1, hint: '〜だけれども', translation: '雨が降っていたけれども、私たちは外出しました。' },
  { type: 'grammar', question: 'I was tired ___ I went to bed early.', options: ['so', 'but', 'or', 'and'], answer: 0, hint: 'だから', translation: '私は疲れていたので、早く寝ました。' },
  { type: 'grammar', question: '___ he is rich, he is not happy.', options: ['Because', 'Although', 'If', 'When'], answer: 1, hint: '〜にもかかわらず', translation: '彼はお金持ちだけれども、幸せではありません。' },
  ...
  // ======== 追加 VOCAB 40問 ========
  { type: 'vocab', question: '「予定」は英語で？', options: ['schedule', 'school', 'science', 'score'], answer: 0, hint: '計画表' },
  { type: 'vocab', question: '「趣味」は英語で？', options: ['history', 'hobby', 'holiday', 'honest'], answer: 1, hint: '好きなこと' },
  { type: 'vocab', question: '「休暇」は英語で？', options: ['village', 'visitor', 'vacation', 'voice'], answer: 2, hint: '休みの日々' },
  { type: 'vocab', question: '「天気」は英語で？', options: ['winter', 'window', 'weather', 'weekend'], answer: 2, hint: '☀️🌧️' },
  { type: 'vocab', question: '「季節」は英語で？', options: ['second', 'secret', 'section', 'season'], answer: 3, hint: '春夏秋冬' },
  { type: 'vocab', question: '「招待する」は英語で？', options: ['invite', 'invent', 'invest', 'insist'], answer: 0, hint: 'パーティーに呼ぶ' },
  { type: 'vocab', question: '「到着する」は英語で？', options: ['answer', 'arrive', 'arrange', 'attend'], answer: 1, hint: '着く' },
  { type: 'vocab', question: '「出発する」は英語で？', options: ['laugh', 'lead', 'leave', 'lend'], answer: 2, hint: '去る' },
  { type: 'vocab', question: '「科目」は英語で？', options: ['subject', 'subway', 'suburb', 'sudden'], answer: 0, hint: '学校で学ぶもの' },
  { type: 'vocab', question: '「試験」は英語で？', options: ['example', 'exam', 'exact', 'expert'], answer: 1, hint: 'テスト' },
  { type: 'vocab', question: '「宿題」は英語で？', options: ['hometown', 'housework', 'homework', 'hospital'], answer: 2, hint: '家でやる勉強' },
  { type: 'vocab', question: '「成績」は英語で？', options: ['grass', 'grape', 'grand', 'grade'], answer: 3, hint: '通知表の...' },
  { type: 'vocab', question: '「同級生」は英語で？', options: ['classmate', 'classroom', 'classic', 'clause'], answer: 0, hint: 'クラスの友達' },
  { type: 'vocab', question: '「出席する」は英語で？', options: ['attack', 'attend', 'attempt', 'attract'], answer: 1, hint: '参加する' },
  { type: 'vocab', question: '「卒業する」は英語で？', options: ['gather', 'graduate', 'grateful', 'guarantee'], answer: 1, hint: '学校を出る' },
  { type: 'vocab', question: '「nervous」の意味は？', options: ['怒った', '緊張した', '退屈した', '疲れた'], answer: 1, hint: 'ドキドキ' },
  { type: 'vocab', question: '「confident」の意味は？', options: ['混乱した', '自信のある', '快適な', '心配した'], answer: 1, hint: '自分を信じる' },
  { type: 'vocab', question: '「patient」の意味は？', options: ['忍耐強い', '情熱的な', '受動的な', '完璧な'], answer: 0, hint: '我慢できる' },
  { type: 'vocab', question: '「curious」の意味は？', options: ['注意深い', '勇敢な', '好奇心のある', '残酷な'], answer: 2, hint: '知りたがり' },
  { type: 'vocab', question: '「generous」の意味は？', options: ['一般的な', '優しい', '天才の', '気前のよい'], answer: 3, hint: '惜しまず与える' },
  { type: 'vocab', question: '「honest」の意味は？', options: ['正直な', '名誉ある', '希望のある', '恐ろしい'], answer: 0, hint: '嘘をつかない' },
  { type: 'vocab', question: '「headache」の意味は？', options: ['腹痛', '頭痛', '腰痛', '歯痛'], answer: 1, hint: '頭が痛い' },
  { type: 'vocab', question: '「medicine」の意味は？', options: ['会議', '記憶', '薬', 'メダル'], answer: 2, hint: '病気の時に飲む' },
  { type: 'vocab', question: '「exercise」の意味は？', options: ['言い訳', '運動', '試験', '展示'], answer: 1, hint: '体を動かす' },
  { type: 'vocab', question: '「diet」の意味は？', options: ['日記', '食事制限', '方言', '会議'], answer: 1, hint: '食生活の改善' },
  { type: 'vocab', question: '「cough」の意味は？', options: ['咳', 'ソファ', 'コーヒー', 'コイン'], answer: 0, hint: 'ゴホゴホ' },
  { type: 'vocab', question: '「fever」の意味は？', options: ['恐怖', '熱', '味', '花'], answer: 1, hint: '体温が高い' },
  { type: 'vocab', question: '「discount」の意味は？', options: ['発見', '割引', '距離', '議論'], answer: 1, hint: 'セール' },
  { type: 'vocab', question: '「receipt」の意味は？', options: ['レシピ', 'レシート', '受付', '復習'], answer: 1, hint: '買い物の証明' },
  { type: 'vocab', question: '「price」の意味は？', options: ['賞', '練習', '値段', '王子'], answer: 2, hint: 'いくら？' },
  { type: 'vocab', question: '「passport」の意味は？', options: ['通行証', 'パスポート', '乗客', '小包'], answer: 1, hint: '海外旅行に必要' },
  { type: 'vocab', question: '「departure」の意味は？', options: ['到着', '出発', '部門', '配達'], answer: 1, hint: '出る時間' },
  { type: 'vocab', question: '「ticket」の意味は？', options: ['チケット', 'テーブル', 'タオル', 'トンネル'], answer: 0, hint: '入場や乗車に必要' },
  { type: 'vocab', question: '「platform」の意味は？', options: ['プラットフォーム', 'プログラム', 'プロジェクト', 'プレゼント'], answer: 0, hint: '駅のホーム' },
  { type: 'vocab', question: '「reservation」の意味は？', options: ['調査', '予約', '革命', '関係'], answer: 1, hint: 'ホテルの...' },
  { type: 'vocab', question: '「pollution」の意味は？', options: ['人口', '汚染', '政治', '位置'], answer: 1, hint: '環境問題' },
  { type: 'vocab', question: '「recycle」の意味は？', options: ['再利用する', '回復する', '記録する', '減らす'], answer: 0, hint: '♻️' },
  { type: 'vocab', question: '「waste」の意味は？', options: ['待つ', '無駄にする', '洗う', '願う'], answer: 1, hint: 'もったいない' },
  { type: 'vocab', question: '「device」の意味は？', options: ['装置', '助言', '開発', '設計'], answer: 0, hint: 'スマホやパソコン' },
  { type: 'vocab', question: '「download」の意味は？', options: ['削除する', 'アップロードする', 'ダウンロードする', '検索する'], answer: 2, hint: 'アプリを入れる' },
  // ======== 追加 GRAMMAR 35問 ========
  { type: 'grammar', question: 'I have ___ to Kyoto twice.', options: ['go', 'went', 'been', 'going'], answer: 2, hint: '経験を表す現在完了', translation: '私は京都に2回行ったことがあります。' },
  { type: 'grammar', question: 'She has ___ this movie three times.', options: ['see', 'saw', 'seen', 'seeing'], answer: 2, hint: '経験を表す現在完了', translation: '彼女はこの映画を3回見たことがあります。' },
  { type: 'grammar', question: 'Have you ever ___ sushi?', options: ['eat', 'ate', 'eaten', 'eating'], answer: 2, hint: '経験を聞く', translation: 'あなたは寿司を食べたことがありますか？' },
  { type: 'grammar', question: 'He has ___ in Tokyo since 2020.', options: ['live', 'lived', 'living', 'lives'], answer: 1, hint: '継続を表す現在完了', translation: '彼は2020年から東京に住んでいます。' },
  { type: 'grammar', question: 'I have just ___ my homework.', options: ['finish', 'finishing', 'finished', 'finishes'], answer: 2, hint: '完了を表す現在完了', translation: '私はちょうど宿題を終えたところです。' },
  { type: 'grammar', question: 'This book is ___ than that one.', options: ['interesting', 'more interesting', 'most interesting', 'interestinger'], answer: 1, hint: '比較級（長い語）', translation: 'この本はあの本より面白いです。' },
  { type: 'grammar', question: 'Mt. Fuji is the ___ mountain in Japan.', options: ['high', 'higher', 'highest', 'most high'], answer: 2, hint: '最上級', translation: '富士山は日本で一番高い山です。' },
  { type: 'grammar', question: 'She runs as ___ as her brother.', options: ['fast', 'faster', 'fastest', 'fastly'], answer: 0, hint: 'as...as（同等比較）', translation: '彼女は兄と同じくらい速く走ります。' },
  { type: 'grammar', question: 'Tom is ___ of the three boys.', options: ['tall', 'taller', 'the tallest', 'the taller'], answer: 2, hint: '3つ以上の最上級', translation: 'トムは3人の少年の中で一番背が高いです。' },
  { type: 'grammar', question: 'This cake is ___ than mine.', options: ['delicious', 'more delicious', 'most delicious', 'deliciouser'], answer: 1, hint: '比較級（長い語）', translation: 'このケーキは私のより美味しいです。' },
  { type: 'grammar', question: 'The window was ___ by the boy.', options: ['break', 'broke', 'broken', 'breaking'], answer: 2, hint: '受動態', translation: '窓はその少年によって割られました。' },
  { type: 'grammar', question: 'English is ___ in many countries.', options: ['speak', 'spoke', 'spoken', 'speaking'], answer: 2, hint: '受動態', translation: '英語は多くの国で話されています。' },
  { type: 'grammar', question: 'This song was ___ by a famous singer.', options: ['sing', 'sang', 'sung', 'singing'], answer: 2, hint: '受動態', translation: 'この歌は有名な歌手によって歌われました。' },
  { type: 'grammar', question: 'I want ___ a doctor in the future.', options: ['be', 'being', 'to be', 'been'], answer: 2, hint: 'want to + 動詞', translation: '私は将来医者になりたいです。' },
  { type: 'grammar', question: 'She decided ___ abroad.', options: ['study', 'studying', 'to study', 'studied'], answer: 2, hint: 'decide to + 動詞', translation: '彼女は海外で勉強することに決めました。' },
  { type: 'grammar', question: 'He tried ___ the heavy box.', options: ['lift', 'lifting', 'to lift', 'lifted'], answer: 2, hint: 'try to + 動詞', translation: '彼はその重い箱を持ち上げようとしました。' },
  { type: 'grammar', question: 'I enjoy ___ books on weekends.', options: ['read', 'to read', 'reading', 'reads'], answer: 2, hint: 'enjoy + 動名詞', translation: '私は週末に本を読むのを楽しみます。' },
  { type: 'grammar', question: 'She finished ___ her report.', options: ['write', 'to write', 'writing', 'wrote'], answer: 2, hint: 'finish + 動名詞', translation: '彼女はレポートを書き終えました。' },
  { type: 'grammar', question: 'Stop ___ so much noise!', options: ['make', 'to make', 'making', 'made'], answer: 2, hint: 'stop + 動名詞', translation: 'そんなに騒ぐのをやめなさい！' },
  { type: 'grammar', question: 'I was doing homework ___ my mother came home.', options: ['when', 'while', 'because', 'if'], answer: 0, hint: '〜した時', translation: '母が帰宅した時、私は宿題をしていました。' },
  { type: 'grammar', question: '___ it was raining, we stayed home.', options: ['If', 'Though', 'Because', 'Until'], answer: 2, hint: '理由を表す接続詞', translation: '雨が降っていたので、私たちは家にいました。' },
  { type: 'grammar', question: 'I will wait ___ you come back.', options: ['when', 'while', 'because', 'until'], answer: 3, hint: '〜まで', translation: 'あなたが戻るまで待ちます。' },
  { type: 'grammar', question: '___ he is young, he is very smart.', options: ['If', 'Though', 'Because', 'Until'], answer: 1, hint: '〜だけれども', translation: '彼は若いけれども、とても賢いです。' },
  { type: 'grammar', question: 'I arrived ___ the station at noon.', options: ['in', 'on', 'at', 'for'], answer: 2, hint: '場所の前置詞', translation: '私は正午に駅に着きました。' },
  { type: 'grammar', question: 'We stayed in Osaka ___ three days.', options: ['in', 'on', 'at', 'for'], answer: 3, hint: '期間を表す前置詞', translation: '私たちは3日間大阪に滞在しました。' },
  { type: 'grammar', question: 'She read a book ___ the vacation.', options: ['for', 'during', 'while', 'between'], answer: 1, hint: '特定の期間中', translation: '彼女は休暇中に本を読みました。' },
  { type: 'grammar', question: 'You ___ be quiet in the library.', options: ['must', 'can', 'may', 'would'], answer: 0, hint: '義務・必要', translation: '図書館では静かにしなければなりません。' },
  { type: 'grammar', question: 'You ___ see a doctor.', options: ['would', 'could', 'should', 'might'], answer: 2, hint: '〜すべきだ', translation: 'あなたは医者に診てもらうべきです。' },
  { type: 'grammar', question: 'It ___ rain tomorrow.', options: ['must', 'should', 'may', 'will'], answer: 2, hint: '〜かもしれない', translation: '明日は雨が降るかもしれません。' },
  { type: 'grammar', question: '___ did you go to the park? — To play tennis.', options: ['What', 'When', 'Where', 'Why'], answer: 3, hint: '理由を聞く', translation: 'なぜ公園に行ったのですか？―テニスをするためです。' },
  { type: 'grammar', question: '___ is your favorite subject?', options: ['Who', 'What', 'Where', 'When'], answer: 1, hint: '何？', translation: 'あなたの好きな科目は何ですか？' },
  { type: 'grammar', question: 'There ___ a cat under the table.', options: ['is', 'are', 'have', 'has'], answer: 0, hint: 'There is/are構文', translation: 'テーブルの下に猫が1匹います。' },
  { type: 'grammar', question: 'There ___ many students in the classroom.', options: ['is', 'are', 'has', 'have'], answer: 1, hint: 'There is/are構文（複数）', translation: '教室にはたくさんの生徒がいます。' },
  { type: 'grammar', question: 'This problem is too difficult ___ understand.', options: ['for', 'to', 'that', 'so'], answer: 1, hint: 'too...to構文', translation: 'この問題は難しすぎて理解できません。' },
  { type: 'grammar', question: 'She is old enough ___ drive a car.', options: ['for', 'to', 'that', 'so'], answer: 1, hint: 'enough to構文', translation: '彼女は車を運転できる年齢です。' },
  // ======== 追加 IDIOM 25問 ========
  { type: 'idiom', question: '"carry on" の意味は？', options: ['運ぶ', '続ける', '持ち帰る', '中止する'], answer: 1, hint: '続行する' },
  { type: 'idiom', question: '"go over" の意味は？', options: ['行き過ぎる', '復習する', '越える', '出かける'], answer: 1, hint: '見直す' },
  { type: 'idiom', question: '"look into" の意味は？', options: ['〜を見る', '〜を調べる', '〜を見つける', '〜を覗く'], answer: 1, hint: '調査する' },
  { type: 'idiom', question: '"break into" の意味は？', options: ['壊す', '分ける', '侵入する', '壊れる'], answer: 2, hint: '不法に入る' },
  { type: 'idiom', question: '"come along" の意味は？', options: ['一緒に来る', '戻る', '離れる', '急ぐ'], answer: 0, hint: '一緒に行こう' },
  { type: 'idiom', question: '"hang out" の意味は？', options: ['洗濯物を干す', '遊ぶ・過ごす', '電話を切る', '外出する'], answer: 1, hint: '友達と...' },
  { type: 'idiom', question: '"in time" の意味は？', options: ['時間通りに', '間に合って', '時間内に', '時間がない'], answer: 1, hint: 'ギリギリ間に合う' },
  { type: 'idiom', question: '"on time" の意味は？', options: ['間に合って', '時間通りに', '早めに', '遅れて'], answer: 1, hint: 'ちょうどの時間に' },
  { type: 'idiom', question: '"for sure" の意味は？', options: ['多分', '確かに', '〜のために', '不確かに'], answer: 1, hint: '間違いなく' },
  { type: 'idiom', question: '"at once" の意味は？', options: ['一度だけ', 'すぐに', '一つずつ', '一緒に'], answer: 1, hint: '今すぐ' },
  { type: 'idiom', question: '"all day long" の意味は？', options: ['毎日', '一日中', '長い間', '一晩中'], answer: 1, hint: '朝から晩まで' },
  { type: 'idiom', question: '"no way" の意味は？', options: ['どういたしまして', '絶対にだめ', '道がない', 'どうぞ'], answer: 1, hint: 'ありえない！' },
  { type: 'idiom', question: '"kind of" の意味は？', options: ['種類の', 'ちょっと・やや', '親切な', '一種の'], answer: 1, hint: '少し' },
  { type: 'idiom', question: '"how come" の意味は？', options: ['どうやって', 'なぜ', 'いつ来る', 'どのように'], answer: 1, hint: 'why と同じ意味' },
  { type: 'idiom', question: '"as a result" の意味は？', options: ['原因として', '結果として', '例として', '理由として'], answer: 1, hint: 'その結果' },
  { type: 'idiom', question: '"in addition" の意味は？', options: ['その代わりに', '加えて', '結果として', '実際には'], answer: 1, hint: 'さらに' },
  { type: 'idiom', question: '"for instance" の意味は？', options: ['例えば', '瞬時に', '当分の間', '確かに'], answer: 0, hint: 'for example と同じ' },
  { type: 'idiom', question: '"on the other hand" の意味は？', options: ['手の上に', '他方では', '握手する', '手伝う'], answer: 1, hint: '一方で' },
  { type: 'idiom', question: '"take after" の意味は？', options: ['追いかける', '似ている', '持っていく', '世話をする'], answer: 1, hint: '親に...' },
  { type: 'idiom', question: '"put away" の意味は？', options: ['捨てる', '片付ける', '離れる', '延期する'], answer: 1, hint: '元の場所に戻す' },
  { type: 'idiom', question: '"run into" の意味は？', options: ['走り込む', '偶然会う', '逃げる', '走り去る'], answer: 1, hint: 'ばったり会う' },
  { type: 'idiom', question: '"bring up" の意味は？', options: ['持ってくる', '育てる', '上げる', '運ぶ'], answer: 1, hint: '子供を...' },
  { type: 'idiom', question: '"get along" の意味は？', options: ['出発する', '仲良くする', '進む', '年を取る'], answer: 1, hint: '人間関係が良い' },
  { type: 'idiom', question: '"make it" の意味は？', options: ['作る', '成功する・間に合う', '決める', '壊す'], answer: 1, hint: 'やり遂げる' },
  { type: 'idiom', question: '"stand out" の意味は？', options: ['立ち上がる', '目立つ', '外に出る', '我慢する'], answer: 1, hint: '際立つ' },
];
...
const grade3Questions = [
  ...
  { type: 'grammar', question: 'I wish I ___ fly.', options: ['can', 'could', 'will', 'would'], answer: 1, hint: '仮定法', translation: '空を飛べたらなあ。' },
  { type: 'grammar', question: 'If I ___ you, I would study harder.', options: ['am', 'was', 'were', 'be'], answer: 2, hint: '仮定法過去', translation: 'もし私があなたなら、もっと一生懸命勉強するのに。' },
  { type: 'grammar', question: 'If I ___ rich, I would travel the world.', options: ['am', 'was', 'were', 'be'], answer: 2, hint: '仮定法過去', translation: 'もし私がお金持ちなら、世界中を旅行するのに。' },
  { type: 'grammar', question: 'I wish I ___ speak French.', options: ['can', 'could', 'may', 'might'], answer: 1, hint: '〜できたらなあ', translation: 'フランス語を話せたらなあ。' },
  { type: 'grammar', question: 'If she ___ here, she would help us.', options: ['is', 'was', 'were', 'be'], answer: 2, hint: '仮定法過去', translation: 'もし彼女がここにいたら、私たちを助けてくれるのに。' },
  { type: 'grammar', question: "I wish it ___ raining.", options: ["isn't", "wasn't", "weren't", "doesn't"], answer: 2, hint: '雨じゃなければ', translation: '雨が降っていなければなあ。' },
  { type: 'grammar', question: 'The book ___ I bought yesterday is interesting.', options: ['who', 'which', 'what', 'when'], answer: 1, hint: '関係代名詞（物）', translation: '昨日買った本はおもしろいです。' },
  { type: 'grammar', question: 'She is the woman ___ helped me.', options: ['who', 'which', 'what', 'whom'], answer: 0, hint: '関係代名詞（人・主格）', translation: '彼女は私を助けてくれた女性です。' },
  { type: 'grammar', question: 'The man ___ I met was a doctor.', options: ['who', 'whom', 'which', 'what'], answer: 1, hint: '関係代名詞（人・目的格）', translation: '私が会った男性は医者でした。' },
  { type: 'grammar', question: 'This is the house ___ he lives.', options: ['which', 'where', 'when', 'what'], answer: 1, hint: '関係副詞（場所）', translation: 'これは彼が住んでいる家です。' },
  { type: 'grammar', question: 'I remember the day ___ we first met.', options: ['which', 'where', 'when', 'what'], answer: 2, hint: '関係副詞（時）', translation: '私たちが初めて会った日を覚えています。' },
  { type: 'grammar', question: 'The reason ___ he was late is unknown.', options: ['which', 'where', 'when', 'why'], answer: 3, hint: '関係副詞（理由）', translation: '彼が遅刻した理由はわかりません。' },
  { type: 'grammar', question: '___ surprised me was his attitude.', options: ['That', 'What', 'Which', 'It'], answer: 1, hint: '関係代名詞what', translation: '私を驚かせたのは彼の態度でした。' },
  { type: 'grammar', question: "I don't know ___ to do.", options: ['how', 'what', 'which', 'where'], answer: 1, hint: '何をすべきか', translation: '私は何をすべきかわかりません。' },
  { type: 'grammar', question: 'He made me ___ the room.', options: ['clean', 'cleaned', 'cleaning', 'to clean'], answer: 0, hint: '使役動詞', translation: '彼は私に部屋を掃除させました。' },
  { type: 'grammar', question: 'I saw him ___ the street.', options: ['cross', 'crossed', 'crossing', 'to cross'], answer: 0, hint: '知覚動詞', translation: '私は彼が通りを渡るのを見ました。' },
  { type: 'grammar', question: 'She let me ___ her car.', options: ['use', 'used', 'using', 'to use'], answer: 0, hint: 'let + 原形', translation: '彼女は私に車を使わせてくれました。' },
  { type: 'grammar', question: 'I heard someone ___ my name.', options: ['call', 'called', 'calling', 'to call'], answer: 0, hint: '知覚動詞', translation: '私は誰かが私の名前を呼ぶのを聞きました。' },
  { type: 'grammar', question: 'My mother had me ___ shopping.', options: ['go', 'went', 'going', 'to go'], answer: 0, hint: 'have + 原形', translation: '母は私に買い物に行かせました。' },
  { type: 'grammar', question: 'I watched the children ___ in the park.', options: ['play', 'played', 'playing', 'to play'], answer: 0, hint: '知覚動詞', translation: '私は子どもたちが公園で遊ぶのを見ました。' },
  { type: 'grammar', question: 'The problem is too difficult ___ solve.', options: ['for', 'to', 'that', 'so'], answer: 1, hint: 'too ~ to ...', translation: 'その問題は難しすぎて解けません。' },
  { type: 'grammar', question: 'I have never seen ___ a beautiful sunset.', options: ['so', 'such', 'very', 'too'], answer: 1, hint: 'such a ~', translation: 'こんなに美しい夕日を見たことがありません。' },
  { type: 'grammar', question: 'Not only he but also I ___ wrong.', options: ['am', 'is', 'are', 'was'], answer: 0, hint: '近い方に合わせる', translation: '彼だけでなく私も間違っています。' },
  { type: 'grammar', question: 'Neither Tom nor I ___ ready.', options: ['am', 'is', 'are', 'was'], answer: 0, hint: '近い方に合わせる', translation: 'トムも私も準備ができていません。' },
  { type: 'grammar', question: 'He is ___ kind that everyone likes him.', options: ['so', 'such', 'very', 'too'], answer: 0, hint: 'so ~ that ...', translation: '彼はとても親切なので、みんなに好かれています。' },
  { type: 'grammar', question: 'She is ___ a kind person that everyone likes her.', options: ['so', 'such', 'very', 'too'], answer: 1, hint: 'such ~ that ...', translation: '彼女はとても親切な人なので、みんなに好かれています。' },
  { type: 'grammar', question: 'It is important ___ you to study hard.', options: ['of', 'for', 'to', 'with'], answer: 1, hint: 'It is ~ for 人 to ...', translation: 'あなたが一生懸命勉強することは大切です。' },
  { type: 'grammar', question: 'It is kind ___ you to help me.', options: ['of', 'for', 'to', 'with'], answer: 0, hint: 'It is ~ of 人 to ...', translation: '手伝ってくれるなんて、あなたは親切ですね。' },
  { type: 'grammar', question: 'I wonder ___ he will come.', options: ['that', 'if', 'what', 'which'], answer: 1, hint: '〜かどうか', translation: '彼が来るかどうか気になります。' },
  { type: 'grammar', question: '___ you study hard, you will pass the exam.', options: ['If', 'Unless', 'Though', 'Because'], answer: 0, hint: 'もし〜なら', translation: 'もし一生懸命勉強すれば、試験に受かるでしょう。' },
  ...
  // === 追加 vocab 40問 ===
  { type: 'vocab', question: '「democracy」の意味は？', options: ['独裁', '民主主義', '共産主義', '君主制'], answer: 1, hint: '国民が主権' },
  { type: 'vocab', question: '「election」の意味は？', options: ['選挙', '演説', '革命', '条約'], answer: 0, hint: '投票で選ぶ' },
  { type: 'vocab', question: '「immigration」の意味は？', options: ['移民', '輸出', '貿易', '観光'], answer: 0, hint: '他国に移り住む' },
  { type: 'vocab', question: '「poverty」の意味は？', options: ['豊かさ', '平等', '貧困', '繁栄'], answer: 2, hint: '貧しいこと' },
  { type: 'vocab', question: '「welfare」の意味は？', options: ['戦争', '福祉', '犯罪', '経済'], answer: 1, hint: '社会的支援' },
  { type: 'vocab', question: '「economy」の意味は？', options: ['生態系', '経済', '教育', '環境'], answer: 1, hint: 'お金の流れ' },
  { type: 'vocab', question: '「experiment」の意味は？', options: ['経験', '実験', '説明', '探検'], answer: 1, hint: '科学で行う' },
  { type: 'vocab', question: '「hypothesis」の意味は？', options: ['仮説', '結論', '事実', '証拠'], answer: 0, hint: 'まだ証明されていない' },
  { type: 'vocab', question: '「molecule」の意味は？', options: ['原子', '分子', '細胞', '元素'], answer: 1, hint: '物質の最小単位' },
  { type: 'vocab', question: '「phenomenon」の意味は？', options: ['哲学', '現象', '理論', '方程式'], answer: 1, hint: '自然に起こること' },
  { type: 'vocab', question: '「innovation」の意味は？', options: ['伝統', '革新', '模倣', '破壊'], answer: 1, hint: '新しいアイデア' },
  { type: 'vocab', question: '「sustainability」の意味は？', options: ['持続可能性', '安定性', '柔軟性', '多様性'], answer: 0, hint: '未来にも続けられる' },
  { type: 'vocab', question: '「renewable」の意味は？', options: ['使い捨ての', '再生可能な', '有害な', '限定的な'], answer: 1, hint: '太陽光など' },
  { type: 'vocab', question: '「emission」の意味は？', options: ['吸収', '排出', '反射', '蒸発'], answer: 1, hint: 'CO2の〜' },
  { type: 'vocab', question: '「conservation」の意味は？', options: ['消費', '保護', '汚染', '開発'], answer: 1, hint: '自然を守る' },
  { type: 'vocab', question: '「ecosystem」の意味は？', options: ['経済体制', '生態系', '社会制度', '教育制度'], answer: 1, hint: '生き物のつながり' },
  { type: 'vocab', question: '「scholarship」の意味は？', options: ['入学金', '奨学金', '授業料', '教科書代'], answer: 1, hint: '勉強のための支援金' },
  { type: 'vocab', question: '「curriculum」の意味は？', options: ['教科書', 'カリキュラム', '時間割', '成績表'], answer: 1, hint: '教育課程' },
  { type: 'vocab', question: '「faculty」の意味は？', options: ['施設', '学部・教授陣', '学生', '卒業式'], answer: 1, hint: '大学の先生たち' },
  { type: 'vocab', question: '「lecture」の意味は？', options: ['実験', '講義', '試験', '宿題'], answer: 1, hint: '大学の授業' },
  { type: 'vocab', question: '「semester」の意味は？', options: ['学期', '学年', '学位', '入学'], answer: 0, hint: '半年ごとの期間' },
  { type: 'vocab', question: '「dissertation」の意味は？', options: ['論文', '授業', '講演', '議論'], answer: 0, hint: '卒業のために書く' },
  { type: 'vocab', question: '「symptom」の意味は？', options: ['治療', '症状', '手術', '薬'], answer: 1, hint: '病気の兆候' },
  { type: 'vocab', question: '「diagnosis」の意味は？', options: ['予防', '診断', '処方', '回復'], answer: 1, hint: '病名を特定する' },
  { type: 'vocab', question: '「treatment」の意味は？', options: ['検査', '診断', '治療', '入院'], answer: 2, hint: '病気を治すこと' },
  { type: 'vocab', question: '「therapy」の意味は？', options: ['薬局', '療法', '手術', '検診'], answer: 1, hint: 'リハビリなど' },
  { type: 'vocab', question: '「prescription」の意味は？', options: ['処方箋', '予防', '手術', '健康診断'], answer: 0, hint: '医者が薬を出す' },
  { type: 'vocab', question: '「surgery」の意味は？', options: ['診察', '注射', '入院', '手術'], answer: 3, hint: 'メスを使う' },
  { type: 'vocab', question: '「negotiate」の意味は？', options: ['拒否する', '交渉する', '命令する', '報告する'], answer: 1, hint: '条件を話し合う' },
  { type: 'vocab', question: '「revenue」の意味は？', options: ['支出', '収益', '借金', '利息'], answer: 1, hint: '会社の売上' },
  { type: 'vocab', question: '「investment」の意味は？', options: ['投資', '貯金', '借金', '消費'], answer: 0, hint: '将来のためにお金を使う' },
  { type: 'vocab', question: '「entrepreneur」の意味は？', options: ['会社員', '公務員', '起業家', '投資家'], answer: 2, hint: '新しいビジネスを始める人' },
  { type: 'vocab', question: '「corporation」の意味は？', options: ['協力', '企業', '組合', '政府'], answer: 1, hint: '大きな会社' },
  { type: 'vocab', question: '「legislation」の意味は？', options: ['立法', '行政', '司法', '選挙'], answer: 0, hint: '法律を作ること' },
  { type: 'vocab', question: '「amendment」の意味は？', options: ['廃止', '修正', '制定', '施行'], answer: 1, hint: '法律を変える' },
  { type: 'vocab', question: '「constitution」の意味は？', options: ['条約', '契約', '憲法', '法令'], answer: 2, hint: '国の最高法規' },
  { type: 'vocab', question: '「anxiety」の意味は？', options: ['喜び', '怒り', '不安', '退屈'], answer: 2, hint: '心配でドキドキ' },
  { type: 'vocab', question: '「frustration」の意味は？', options: ['満足', '欲求不満', '興奮', '感動'], answer: 1, hint: 'イライラ' },
  { type: 'vocab', question: '「compassion」の意味は？', options: ['競争', '思いやり', '情熱', '衝動'], answer: 1, hint: '他人を気遣う心' },
  { type: 'vocab', question: '「resilience」の意味は？', options: ['抵抗', '回復力', '忍耐', '柔軟性'], answer: 1, hint: '困難から立ち直る力' },
  // === 追加 grammar 35問 ===
  { type: 'grammar', question: 'If I had known the truth, I ___ told you.', options: ['will have', 'would have', 'should', 'could'], answer: 1, hint: '仮定法過去完了', translation: 'もし真実を知っていたら、あなたに伝えていたのに。' },
  { type: 'grammar', question: 'I wish I ___ studied harder for the exam.', options: ['have', 'had', 'would', 'could'], answer: 1, hint: '仮定法過去完了', translation: '試験のためにもっと勉強すればよかった。' },
  { type: 'grammar', question: 'The girl ___ father is a doctor wants to be a nurse.', options: ['who', 'which', 'whose', 'whom'], answer: 2, hint: '関係代名詞（所有格）', translation: '父親が医者であるその少女は看護師になりたがっている。' },
  { type: 'grammar', question: 'This is the restaurant ___ we had dinner last week.', options: ['which', 'where', 'that', 'when'], answer: 1, hint: '関係副詞（場所）', translation: 'ここは先週私たちが夕食をとったレストランです。' },
  { type: 'grammar', question: '___ along the river, I found a beautiful flower.', options: ['Walk', 'Walked', 'Walking', 'To walk'], answer: 2, hint: '分詞構文', translation: '川沿いを歩いていると、美しい花を見つけた。' },
  { type: 'grammar', question: '___ finished his homework, he went out to play.', options: ['Have', 'Having', 'Had', 'Has'], answer: 1, hint: '分詞構文（完了形）', translation: '宿題を終えて、彼は遊びに出かけた。' },
  { type: 'grammar', question: 'The teacher made the students ___ the test again.', options: ['take', 'took', 'taken', 'taking'], answer: 0, hint: '使役動詞 make', translation: '先生は生徒たちにテストをもう一度受けさせた。' },
  { type: 'grammar', question: 'I felt the ground ___ during the earthquake.', options: ['shake', 'shook', 'shaken', 'shaking'], answer: 0, hint: '知覚動詞 feel', translation: '地震の間、地面が揺れるのを感じた。' },
  { type: 'grammar', question: 'The box was ___ heavy for me to carry.', options: ['very', 'so', 'too', 'such'], answer: 2, hint: 'too...to構文', translation: 'その箱は重すぎて私には運べなかった。' },
  { type: 'grammar', question: 'It was ___ a hot day that nobody wanted to go outside.', options: ['so', 'such', 'very', 'too'], answer: 1, hint: 'such...that構文', translation: 'とても暑い日だったので、誰も外に出たがらなかった。' },
  { type: 'grammar', question: 'He ran ___ fast that I couldn\'t catch up with him.', options: ['so', 'such', 'too', 'very'], answer: 0, hint: 'so...that構文', translation: '彼はとても速く走ったので、私は追いつけなかった。' },
  { type: 'grammar', question: 'It seems ___ he is very busy these days.', options: ['like', 'that', 'as', 'if'], answer: 1, hint: 'It seems that...', translation: '彼は最近とても忙しいようだ。' },
  { type: 'grammar', question: 'She appears ___ be happy with the result.', options: ['for', 'to', 'that', 'as'], answer: 1, hint: 'appear to...', translation: '彼女はその結果に満足しているようだ。' },
  { type: 'grammar', question: 'He said that he ___ finish the work by Friday.', options: ['will', 'would', 'can', 'shall'], answer: 1, hint: '間接話法（時制の一致）', translation: '彼は金曜日までに仕事を終えると言った。' },
  { type: 'grammar', question: 'She told me that she ___ been to Paris twice.', options: ['has', 'had', 'have', 'having'], answer: 1, hint: '間接話法（過去完了）', translation: '彼女は私にパリに2回行ったことがあると言った。' },
  { type: 'grammar', question: 'You are ___ to finish the report by tomorrow.', options: ['supposed', 'expected', 'wanted', 'hoped'], answer: 0, hint: 'be supposed to', translation: 'あなたは明日までにレポートを終えることになっている。' },
  { type: 'grammar', question: 'Students are ___ to arrive on time.', options: ['supposed', 'expected', 'wanted', 'wished'], answer: 1, hint: 'be expected to', translation: '生徒は時間通りに到着することが期待されている。' },
  { type: 'grammar', question: 'By next year, I ___ lived here for ten years.', options: ['will', 'will have', 'have', 'had'], answer: 1, hint: '未来完了', translation: '来年までに、ここに10年住んでいることになる。' },
  { type: 'grammar', question: 'She ___ been waiting for two hours when he arrived.', options: ['has', 'had', 'have', 'was'], answer: 1, hint: '過去完了進行形', translation: '彼が到着した時、彼女は2時間待ち続けていた。' },
  { type: 'grammar', question: 'It ___ Tom that broke the window.', options: ['is', 'was', 'were', 'has'], answer: 1, hint: '強調構文', translation: '窓を割ったのはトムだった。' },
  { type: 'grammar', question: 'Not only ___ he speak English, but he also speaks French.', options: ['do', 'does', 'is', 'has'], answer: 1, hint: '倒置（Not only...）', translation: '彼は英語を話すだけでなく、フランス語も話す。' },
  { type: 'grammar', question: 'Never ___ I seen such a beautiful painting.', options: ['had', 'have', 'has', 'did'], answer: 1, hint: '倒置（Never...）', translation: 'こんなに美しい絵を見たことがない。' },
  { type: 'grammar', question: 'I had my car ___ at the garage yesterday.', options: ['repair', 'repaired', 'repairing', 'to repair'], answer: 1, hint: 'have + O + 過去分詞', translation: '昨日、車を修理してもらった。' },
  { type: 'grammar', question: '___ from the top of the tower, the city looked small.', options: ['See', 'Seeing', 'Seen', 'To see'], answer: 2, hint: '分詞構文（受動）', translation: '塔の上から見ると、街は小さく見えた。' },
  { type: 'grammar', question: 'The woman ___ I spoke to was very kind.', options: ['who', 'whom', 'whose', 'which'], answer: 1, hint: '関係代名詞（目的格）', translation: '私が話しかけた女性はとても親切だった。' },
  { type: 'grammar', question: 'He asked me ___ I had ever been to London.', options: ['that', 'if', 'what', 'which'], answer: 1, hint: '間接疑問文', translation: '彼は私にロンドンに行ったことがあるか尋ねた。' },
  { type: 'grammar', question: 'She speaks English as if she ___ a native speaker.', options: ['is', 'was', 'were', 'be'], answer: 2, hint: '仮定法（as if）', translation: '彼女はまるでネイティブスピーカーのように英語を話す。' },
  { type: 'grammar', question: 'The letter ___ yesterday hasn\'t arrived yet.', options: ['sending', 'sent', 'send', 'to send'], answer: 1, hint: '過去分詞の後置修飾', translation: '昨日送られた手紙はまだ届いていない。' },
  { type: 'grammar', question: 'I don\'t know the reason ___ she was angry.', options: ['which', 'what', 'why', 'how'], answer: 2, hint: '関係副詞（理由）', translation: '彼女が怒っていた理由がわからない。' },
  { type: 'grammar', question: '___ it not been for your help, I would have failed.', options: ['Had', 'Have', 'Has', 'If'], answer: 0, hint: '仮定法（倒置）', translation: 'あなたの助けがなかったら、私は失敗していただろう。' },
  { type: 'grammar', question: 'He is the tallest boy ___ I have ever met.', options: ['who', 'whom', 'that', 'which'], answer: 2, hint: '最上級 + 関係代名詞', translation: '彼は私が今まで会った中で一番背が高い男の子だ。' },
  { type: 'grammar', question: 'She suggested that we ___ the meeting.', options: ['postpone', 'postponed', 'postponing', 'to postpone'], answer: 0, hint: '仮定法現在（suggest that）', translation: '彼女は会議を延期することを提案した。' },
  { type: 'grammar', question: 'The movie was so boring ___ I fell asleep.', options: ['as', 'that', 'which', 'than'], answer: 1, hint: 'so...that構文', translation: 'その映画はとても退屈だったので、私は眠ってしまった。' },
  { type: 'grammar', question: 'My mother always lets me ___ what I want.', options: ['do', 'did', 'doing', 'to do'], answer: 0, hint: 'let + 原形', translation: '母はいつも私に好きなことをさせてくれる。' },
  { type: 'grammar', question: 'He ___ to have been a famous actor in his youth.', options: ['says', 'is said', 'said', 'has said'], answer: 1, hint: 'be said to...', translation: '彼は若い頃、有名な俳優だったと言われている。' },
  // === 追加 idiom 25問 ===
  { type: 'idiom', question: '"account for" の意味は？', options: ['説明する', '会計する', '責任を取る', '計算する'], answer: 0, hint: '理由を述べる' },
  { type: 'idiom', question: '"bring up" の意味は？', options: ['持ち上げる', '育てる・話題に出す', '運ぶ', '壊す'], answer: 1, hint: '話を切り出す' },
  { type: 'idiom', question: '"look down on" の意味は？', options: ['見下ろす', '見下す', '見守る', '見落とす'], answer: 1, hint: '軽蔑する' },
  { type: 'idiom', question: '"make out" の意味は？', options: ['外出する', '理解する', '作り上げる', '逃げる'], answer: 1, hint: '判別する' },
  { type: 'idiom', question: '"rule out" の意味は？', options: ['支配する', '除外する', '決定する', '証明する'], answer: 1, hint: '可能性を消す' },
  { type: 'idiom', question: '"stand out" の意味は？', options: ['立ち上がる', '外に立つ', '目立つ', '我慢する'], answer: 2, hint: '他より際立つ' },
  { type: 'idiom', question: '"take over" の意味は？', options: ['持ち帰る', '引き継ぐ', '取り消す', '持ち上げる'], answer: 1, hint: '後を引き受ける' },
  { type: 'idiom', question: '"to a certain extent" の意味は？', options: ['確実に', 'ある程度', '完全に', '全く'], answer: 1, hint: 'ある範囲まで' },
  { type: 'idiom', question: '"in the first place" の意味は？', options: ['最初の場所で', 'そもそも', '一番目に', '最前列で'], answer: 1, hint: 'もともと' },
  { type: 'idiom', question: '"for the sake of" の意味は？', options: ['〜の代わりに', '〜のために', '〜にもかかわらず', '〜の結果'], answer: 1, hint: '〜を思って' },
  { type: 'idiom', question: '"in light of" の意味は？', options: ['光の中で', '〜を考慮すると', '明るくする', '照らす'], answer: 1, hint: '〜に照らして' },
  { type: 'idiom', question: '"with respect to" の意味は？', options: ['尊敬して', '〜に関して', '敬意を込めて', '〜を除いて'], answer: 1, hint: '〜について' },
  { type: 'idiom', question: '"moreover" の意味は？', options: ['しかし', 'さらに', 'それゆえ', '一方で'], answer: 1, hint: '加えて' },
  { type: 'idiom', question: '"nevertheless" の意味は？', options: ['さらに', 'したがって', 'それにもかかわらず', '例えば'], answer: 2, hint: 'それでも' },
  { type: 'idiom', question: '"furthermore" の意味は？', options: ['しかしながら', 'その上', 'その結果', 'それとも'], answer: 1, hint: 'さらに加えて' },
  { type: 'idiom', question: '"consequently" の意味は？', options: ['同時に', '反対に', 'その結果', 'さらに'], answer: 2, hint: 'だから' },
  { type: 'idiom', question: '"whereas" の意味は？', options: ['どこでも', '一方で', 'なぜなら', 'いつでも'], answer: 1, hint: '対比を示す' },
  { type: 'idiom', question: '"hit the nail on the head" の意味は？', options: ['失敗する', '的を射る', '釘を打つ', '頭を打つ'], answer: 1, hint: '正確に言い当てる' },
  { type: 'idiom', question: '"beat around the bush" の意味は？', options: ['茂みを叩く', '遠回しに言う', '急いで話す', '正直に言う'], answer: 1, hint: '核心を避ける' },
  { type: 'idiom', question: '"get the hang of" の意味は？', options: ['ぶら下がる', 'コツをつかむ', '手に入れる', '吊るす'], answer: 1, hint: 'やり方を覚える' },
  { type: 'idiom', question: '"keep an eye on" の意味は？', options: ['目をそらす', '見て見ぬふりをする', '注意して見る', '目を閉じる'], answer: 2, hint: '監視する' },
  { type: 'idiom', question: '"by means of" の意味は？', options: ['〜のそばで', '〜によって', '〜の意味で', '〜にもかかわらず'], answer: 1, hint: '〜を用いて' },
  { type: 'idiom', question: '"as opposed to" の意味は？', options: ['〜に賛成して', '〜に加えて', '〜とは対照的に', '〜と同様に'], answer: 2, hint: '〜と比べて' },
  { type: 'idiom', question: '"on the contrary" の意味は？', options: ['同様に', 'その通り', 'それどころか', 'ところで'], answer: 2, hint: '反対に' },
  { type: 'idiom', question: '"in terms of" の意味は？', options: ['条件として', '〜の観点から', '用語で', '〜の期間で'], answer: 1, hint: '〜の面では' },
];
    ...
    return (
      ...
      >
        <span className="px-4 py-2 rounded-full font-bold whitespace-nowrap" style={{
          ...
          fontSize: `${Math.max(22, Math.min(38, 30 * sz.scale))}px`,
    ...
    return (
      ...
      >
        <div className="rounded-full overflow-hidden shadow-lg flex items-center justify-center" style={{
          width: `${Math.max(88, Math.min(140, 120 * sz.scale))}px`,
          height: `${Math.max(88, Math.min(140, 120 * sz.scale))}px`,
